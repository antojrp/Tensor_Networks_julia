...
let
  ...
  io1 = open("resultados/TEBD_entrelazamiento_$p.txt","w")
  io2 = open("resultados/TEBD_tiempo_$p.txt","w")
  io3 = open("resultados/TEBD_error_$p.txt","w")
  close(io1)
  close(io2)
  close(io3)
  ...
  for num in 1:m
    N=Ni+num-1
    #Print 
    io1 = open("resultados/TEBD_entrelazamiento_$p.txt","a")
    io2 = open("resultados/TEBD_tiempo_$p.txt","a")
    io3 = open("resultados/TEBD_error_$p.txt","a")
    ...
    write(io3,"Layer   Error var(error)\n")
      ...
      let
        ...
        @time for i in 1:L
          ...
          t=@elapsed for j in 1:2
            psiD=apply(circuit[2*(i-1)+j],psiD;cutoff=1E-10,maxdim=D)
          end
          tiempo[k,i]=t
